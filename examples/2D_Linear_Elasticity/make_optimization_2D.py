...
if __name__ == "__main__":
  ...
  crafted_problem = Steady_State_Crafter(cf, sim, [perm], [max_vol], filters=[filter_])
  ...
  crafted_problem.optimize(optimizer="nlopt-mma", action="minimize", max_it=75, initial_guess=p)
