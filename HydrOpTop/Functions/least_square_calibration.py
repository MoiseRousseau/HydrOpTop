...
class Least_Square_Calibration(Base_Function):
    r"""
    ...
    """
    def __init__(self, head, cell_ids=None, XYZ_coordinates=None, time_obs=None, weights=None,
    ):
      super(Least_Square_Calibration, self).__init__()
      ...
      self.residuals = None # for plotting
    ...
    def __evaluate_cell_ids__(self,p):
        ...
        return self.weights * self.residuals
  ...
  ### PARTIAL DERIVATIVES ###
    ...
    def __d_objective_dh_xyz__(self, p):
        ...
        Use current simulation state
        """
        dobj = np.diag(self.weights) @ np.array([
